  ...
  useEffect(() => {
    if (!isNew && existingAssignment) {
      setFormData({
        ...
        availableFrom: existingAssignment.availableFrom ? existingAssignment.availableFrom.split('T')[0] : '',
        availableUntil: existingAssignment.availableUntil ? existingAssignment.availableUntil.split('T')[0] : '',
